...
N = 6; % liczba węzłów interpolacji wzdłuż osi Y (stopień wielomianu zmiennej y: N-1)
...
F_coarse = cos(3*X_coarse) + cos(-1*Y_coarse); % zadanie A: zmień definicję funkcji interpolowanej
